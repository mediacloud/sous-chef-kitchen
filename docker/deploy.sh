...
sed -e 's/DEPLOYMENT_NAME/$KITCHEN_DEPLOYMENT_NAME/g' -e 's/WORK_POOL_NAME/$PREFECT_WORK_POOL_NAME/g' -e 's/GIT_TAG/$TAG/g' $SCRIPT_DIR/prefect.yaml.in >> $PREFECT_FILE
