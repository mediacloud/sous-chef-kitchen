...
the ci/cd script at 'docker/deploy.sh' will launch a docker service containing four images:
...
3. prefect-worker: a prefect worker process- actually exectures sous-chef runs.
